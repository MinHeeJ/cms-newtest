...
export function PageHeader({
  ...
  return (
    <div className="mb-6 overflow-hidden rounded-lg border border-border bg-lightsecondary/70 py-5 shadow-none dark:border-[#333f55]">
      <div className="grid grid-cols-12 items-center gap-6 px-6">
        <div className="col-span-12 md:col-span-9">
          ...
          <h1 className="mb-2 text-2xl font-semibold tracking-tight text-foreground dark:text-white">
            {title}
          </h1>
          {description ? (
